...
export const selectHasAvatarPresent = (state) => get(state, 'profile.hasAvatarPresent', true)
export const selectHasCoverImagePresent = (state) => get(state, 'profile.hasCoverImagePresent', true)

...
export class ElloDonutMark extends React.Component {
  render() {
    const { classListName } = this.props
    return (
      <SVGBox className={classListName}>
        ...
        <path style={{fill: 'white' }} d="M31.6,23c-1.4,5.3-6.1,9-11.6,9S9.8,28.3,8.4,23c-0.2-0.6,0.2-1.2,0.8-1.4c0.6-0.2,1.2,0.2,1.4,0.8 c1.1,4.3,5,7.3,9.4,7.3c4.4,0,8.3-3,9.4-7.3c0.2-0.6,0.8-1,1.4-0.8C31.4,21.7,31.8,22.4,31.6,23z"/>
...
ElloDonutMark.defaultProps = {
  classListName: 'ElloDonutMark',
}

ElloDonutMark.propTypes = {
  classListName: React.PropTypes.string.isRequired,
}

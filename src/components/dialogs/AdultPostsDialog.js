...
const AdultPostsDialog = ({ user, onConfirm }) =>
  <div className="Dialog AdultPostsDialog">
    ...
    <p>When you set "Post Adult Content" to yes, users who do not wish to view adult content will need to click a link that looks like the one below to view your posts.</p>

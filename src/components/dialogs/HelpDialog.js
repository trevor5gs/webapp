...
const HelpDialog = () =>
  <div className="Dialog HelpDialog">
    ...
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.FOLLOWING }</span> Navigate to following</p>
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.STARRED }</span> Navigate to starred</p>
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.NOTIFICATIONS }</span> View notifications</p>
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.TOGGLE_LAYOUT }</span> Toggle grid mode for main content</p>
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.OMNIBAR }</span> Focus post editor</p>
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.ESC.toUpperCase() }</span> Close modal or alerts</p>
    <p><span className="ShortcutLabel">{ SHORTCUT_KEYS.FULLSCREEN }</span> Toggle fullscreen within a post editor</p>
